...
def print_credits():
	...
	table.add_row("Digital Watermarking", "adityasinghsja123@gmail.com ")
	table.add_row("to Hide Text Messages","mahendra.mk174@gmail.com")
	console.print(table)
...
if __name__ == "__main__":
	...
	print_credits()
	print()
	print("[bold]Image Steganography[/bold] allows you to hide texts inside an image. You can also protect these texts with a password using AES-256.")
	print()
